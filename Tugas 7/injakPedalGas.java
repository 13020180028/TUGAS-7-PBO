abstract public class Mobil implements PropertiInM{
 ...
 abstract public void injakPedalGas(); 
	public void injakRem(){  System.out.println("Mobil berhenti!");  } 
		} class Kijang extends Mobil{ public void injakPedalGas(){
		 System.out.println("Mobil Melaju dengan kecepatan 100 Km/jam...");  }  
			...
			} class BMW extends Mobil {  public void injakPedalGas(){
			 System.out.println("Mobil Melaju dengan kecepatan 100 Km/jam...");  } 
